...
ActiveRecord::Schema.define(version: 20170326073759) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.index ["question_template_id"], name: "index_posts_on_question_template_id", using: :btree
  end
  ...
  add_foreign_key "posts", "question_templates"
